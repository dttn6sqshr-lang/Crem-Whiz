...
class Game(commands.Cog):
    def __init__(self, bot):
        ...
        self.total_scores = {}   # points across rounds in this session
        self.recent_words = []
    ...
    async def gamestart(self, interaction: discord.Interaction):
        ...
        await interaction.response.defer()  # defer instead of sending a separate message
    ...
    async def hint(self, interaction: discord.Interaction):
        ...
        self.timer = max(self.timer - 10, 0)  # optional penalty
    ...
    async def on_message(self, message):
        ...
        if guess == target:
            ...
            # ✅ Start new round only; do not send old round embed
    ...
    async def end_game(self, manual=False):
        ...
        self.game_running = False  # stop on_message
