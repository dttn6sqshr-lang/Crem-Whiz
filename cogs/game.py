...
class Game(commands.Cog):
    def __init__(self, bot):
        ...
        self.channel = None
        self.round = 0
        self.streaks = {}  # player -> streak
        self.round_scores = {}  # player -> round points
        self.word = ""
        self.word_display = []
        self.hearts = 5
        self.timer = 60
    ...
    async def gamestart(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(f"Starting round {self.round}...")

        # Send main round embed
    ...
    # ===== Process guesses from normal chat =====
