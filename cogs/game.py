...
class Game(commands.Cog):
    ...
    async def startgame(self, interaction: discord.Interaction):
        ...
        await self.update_embed(interaction.channel, hint_text=hint)
    ...
    async def hint(self, interaction: discord.Interaction):
        ...
        await self.update_embed(interaction.channel, hint_text=hint_text)
    ...
    async def on_message(self, message: discord.Message):
        ...
        if guess == word_to_guess:
            ...
            await self.update_embed(message.channel, hint_text=hint)
            self.round_task = asyncio.create_task(self.round_timer())
        else:
