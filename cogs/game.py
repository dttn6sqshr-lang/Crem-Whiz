...
class Game(commands.Cog):
    ...
    # ------------------- START GAME ------------------- #
    @discord.slash_command(name="gamestart", description="Start a new Guess the Word game")
    ...
    async def timer_loop(self):
        while self.time_left > 0:
            ...
            await self.send_embed()  # update embed with animated hearts
    ...
    def heart_timer(self):
        ...
        # simple animation: flip hearts every second
...
"""
    ...
    # ------------------- HINT ------------------- #
    @discord.slash_command(name="hint", description="Get a hint for the current word")
    ...
    # ------------------- POWER UPS ------------------- #
    @discord.slash_command(name="revealletter", description="Reveal a letter in the word")
    ...
    @discord.slash_command(name="doublepoints", description="Get double points for this round")
